...
namespace PEMVIS
{
    public partial class FormTransaksi : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Transaksi tranInsert = new Transaksi(textBox8.Text, textBox2.Text, textBox3.Text, textBox4.Text, comboBox1.Text, textBox9.Text, textBox6.Text, textBox11.Text, textBox12.Text, textBox13.Text);
            ...
            {
                Transaksi tranUpdate = new Transaksi(textBox8.Text, textBox2.Text, textBox3.Text, textBox4.Text, comboBox1.Text, textBox9.Text, textBox6.Text, textBox11.Text, textBox12.Text, textBox13.Text);
        ...
        {
            if (MessageBox.Show("Anda yakin transaksi selesai " + textBox8.Text + "?", "Konfirmasi Selesai", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                Transaksi tran = new Transaksi(textBox8.Text, "", "", "", "", "", "", "", "", "");
                if (tran.delete(textBox8.Text) == 1)
                {
                    MessageBox.Show("Transaksi " + textBox1.Text + "Selesai");
                }
                else
                {
                    MessageBox.Show("Transaksi " + textBox1.Text + " gagal");
                }
                loadTran();
                resetTombol();
            }
